...
data = [[2.e3, 1.e0, 1.e0, 1.e-4, 1.e13],
        [2.e3, 1.e0, 1.e0, 1.e-1, 1.e13],
        [2.e3, 1.e-10, 1.e0, 1.e-4, 1.e13],
        [2.e4, 1.e-10, 1.e0, 1.e-4, 1.e13],
        [2.e8, 1.e-10, 1.e0, 1.e-4, 1.e13],
        [2.e4, 1.e0, 1.e0, 1.e-4, 1.e13],
...
for i in range(7):
    print(reaction_rates.updt_Ngamma(data[i][0], data[i][1], data[i][2], data[i][3], data[i][4]))
